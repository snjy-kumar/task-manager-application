        ...
        <div className="p-6 min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {statusColumns.map(column => (
                    <div
                        key={column.id}
                        className={`rounded-xl ${column.bgColor} border border-gray-200 dark:border-gray-700 min-h-[500px]`}
                        ...
                        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="px-2 py-0.5 text-xs bg-gray-200 dark:bg-gray-700 rounded-full text-gray-600 dark:text-gray-300">
                            ...
                            {getTasksByStatus(column.id).map(task => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm cursor-pointer hover:shadow-md transition-all ${draggedTask?._id === task._id ? 'opacity-50 scale-95' : ''
                                            }`}
                                    >
                                        {/* Priority Badge */}
