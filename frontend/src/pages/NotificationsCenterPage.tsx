                ...
                <div className="space-y-3">
                    {notifications.map(notification => (
                        <div
                            ...
                            className={`bg-card rounded-xl shadow-sm border border-border p-4 transition-all hover:shadow-md ${!notification.isRead ? 'bg-amber-500/5' : ''
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-start justify-between mb-1">
                                        ...
                                        {!notification.isRead && (
                                            <span className="flex-shrink-0 w-2 h-2 rounded-full bg-amber-500 ml-2 mt-1.5"></span>
                                        )}
                                    </div>
                                    ...
                                    {notification.task && (
                                        <div className="inline-flex items-center gap-2 text-xs text-gray-500 dark:text-gray-500 mb-2">
                                            ...
                                            <span className={`px-2 py-0.5 rounded ${notification.task.priority === 'High' ? 'bg-red-100 text-red-700 dark:bg-red-900/20 dark:text-red-400' :
                                                notification.task.priority === 'Medium' ? 'bg-amber-500/15 text-amber-400' :
